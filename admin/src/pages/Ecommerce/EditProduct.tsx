      ...
      current.map((item) =>
        item.size === size
          ? {
              ...
              availability_status:
                Math.max(0, stock) > 0 ? "in_stock" : "out_of_stock",
            }
          : item,
      ),
    );
              ...
              <div className="col-span-full">
                ...
                {slugLocked && (
                  <p className="mt-1.5 text-xs text-amber-600 dark:text-amber-400">
                    Slug is manually set. Click the lock icon to reset to
                    auto-generated.
                  </p>
                )}
              </div>
            ...
            <div className="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Stock is controlled per selected size and product stock is
              ...
              {selectedSizes.length === 0 ? (
                <p className="text-sm text-amber-600 dark:text-amber-400">
                  Select one or more sizes above to manage inventory.
                </p>
              ) : (
            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-wrap gap-4">
                ...
                {product.images && product.images.length > 0 && (
                  <div
                    key={`featured-${product.images[0].id}`}
            ...
            {newImagePreviews.length > 0 && (
              <div className="mt-4">
                <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">
                  {newImagePreviews.length} file(s) selected
                </p>
