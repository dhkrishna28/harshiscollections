      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
            ...
            <Link to="/about-us" className="hover:text-primary-600 transition-colors">About</Link>
            ...
            {isAuthenticated ? (
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white border rounded-md shadow-lg hidden group-hover:block">
                  <Link to="/account/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">My Profile</Link>
              ...
              <div className="flex items-center gap-2">
                <Link to="/auth/login" className="text-sm font-medium text-gray-700 hover:text-primary-600">Login</Link>
                <Link to="/auth/signup" className="btn-primary text-sm py-1.5 px-4">Sign Up</Link>
              </div>
            )}
          </div>
        </div>
